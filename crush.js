...
function magic()
{
	...
	if(simsubscreennum==1)
	{
		...
		animateArrowATPosition(355,495,90);	
		document.getElementById("can1-2").onclick=function()
		{
			...
			animateArrowATPosition(180,140,-90);	
			document.getElementById("can1-4").onclick=function()
			{
				...
				setTimeout(function()
				{
					...
					myInt = setInterval(function(){ animatearrow(); }, 500);
					animateArrowATPosition(464,495,90);	
					document.getElementById("can1-3").onclick=function()
					{
						...
						myInt = setInterval(function(){ animatearrow(); }, 500);
						animateArrowATPosition(700,220,360);	
	...
	else if (simsubscreennum==2)
	{
		...
		myInt = setInterval(function(){ animatearrow(); }, 500);
		animateArrowATPosition(550,335,270);
		document.getElementById("can2-2").onclick=function()
		{
			...
			{
				myInt = setInterval(function(){ animatearrow(); }, 500);
				animateArrowATPosition(750,335,270);
				document.getElementById("can2-3").onclick=function()
				{
					...
					setTimeout(function()
					{
						...
						myInt = setInterval(function(){ animatearrow(); }, 500);
						animateArrowATPosition(580,225,360);
						document.getElementById("can2-4").onclick=function()
						{
							...
							setTimeout(function()
							{
								...
								document.
								getElementById("can2-6").style.visibility="visible";
								myInt = setInterval(function(){ animatearrow(); }, 500);
								animateArrowATPosition(650,260,360);
	...
	else if (simsubscreennum==3)
	{
		...
		myInt = setInterval(function(){ animatearrow(); }, 500);
		animateArrowATPosition(450,350,360);
		document.getElementById("can3-2").onclick=function()
		{
			...
			setTimeout(function()
			{
				...
				myInt = setInterval(function(){ animatearrow(); }, 500);
				animateArrowATPosition(370,210,270);
				document.getElementById("can3-3").onclick=function()
				{
					myStopFunction();
					document.getElementById("can3-3").onclick = "";
					document.getElementById("can3-3").style = "position:absolute; left:640px; top:195px;";
					myInt = setInterval(function(){ animatearrow(); }, 500);
					animateArrowATPosition(700,220,180);
					document.getElementById("can3-1l").onclick=function()
					{
						...
						myInt = setInterval(function(){ animatearrow(); }, 500);
						animateArrowATPosition(880,220,360);
						document.getElementById("can3-1r").onclick=function()
						{
							...
							document.getElementById("can3-3").style.visibility = "visible";
							myInt = setInterval(function(){ animatearrow(); }, 500);
							animateArrowATPosition(720,480,90);
							document.getElementById("can3-1on").onclick=function()
							{
								...
								document.getElementById("can3-2").style="position:absolute; left:650px; top:195px; width:110px;";
	...
	else if (simsubscreennum==4)
	{
		...
		myInt = setInterval(function(){ animatearrow(); }, 500);
		animateArrowATPosition(680,260,360);
		document.getElementById("can4-3r").onclick=function()
		{
			...
			myInt = setInterval(function(){ animatearrow(); }, 500);
			animateArrowATPosition(500,250,180);
			document.getElementById("can4-3l").onclick=function()
			{
				...
				myInt = setInterval(function(){ animatearrow(); }, 500);
				animateArrowATPosition(590,240,270);
				document.getElementById("can4-3").onclick=function()
				{
					...
					document.getElementById("can4-2").onclick=function()
					{
						...
						setTimeout(function()
						{
							...
							myInt = setInterval(function(){ animatearrow(); }, 500);
							animateArrowATPosition(350,290,270);
							document.getElementById("can4-7").onclick=function()
							{
								myStopFunction();
								document.getElementById("can4-7").style.visibility="hidden";
								myInt = setInterval(function(){ animatearrow(); }, 500);
								animateArrowATPosition(350,300,270);
								document.getElementById("can4-6").onclick=function()
								{
									myStopFunction();
									document.getElementById("can4-6").onclick="";		
									document.getElementById("can4-6").style="position:absolute; left:500px; top:335px;";
									document.getElementById("can4-8").style.visibility="visible";
									myInt = setInterval(function(){ animatearrow(); }, 500);
									animateArrowATPosition(450,400,360);
									document.getElementById("can4-5").onclick=function()
									{
										myStopFunction();
										document.getElementById("can4-5").onclick="";		
										document.getElementById("can4-5").style="position:absolute; left:710px; top:300px;";
										document.getElementById("can4-8").style="position:absolute; left:720px; top:330px;";
										setTimeout(function()
										{
											...
											myInt = setInterval(function(){ animatearrow(); }, 500);
											animateArrowATPosition(715,400,180);
											document.getElementById("can4-5").onclick=function()
											{
												myStopFunction();
												document.getElementById("can4-5").onclick="";	
												...
												setTimeout(function()
												{
													document.getElementById("can4-10").style="position:absolute; left:350px; top:150px;";
	...
	else if (simsubscreennum==5)
	{
		...
		myInt = setInterval(function(){ animatearrow(); }, 500);
		animateArrowATPosition(484,500,90);
		document.getElementById("can5-1a").onclick=function()
		{
			...
			{
				myInt = setInterval(function(){ animatearrow(); }, 500);
				animateArrowATPosition(599,500,90);
				document.getElementById("can5-1b").onclick=function(){
					...
					myInt = setInterval(function(){ animatearrow(); }, 500);
					animateArrowATPosition(250,370,360);
	...
	else if(simsubscreennum==6)
	{
		...
		myInt=setInterval(function(){animatearrow();},500);
		animateArrowATPosition(164,505,90);
		document.getElementById("can6-1a").onclick=function()
		{
			...
			myInt=setInterval(function(){animatearrow();},500);
			animateArrowATPosition(270,505,90);
			...
			myInt=setInterval(function(){animatearrow();},500);
			animateArrowATPosition(520,330,180);
	...
	else if(simsubscreennum==7)
	{
		...
		myInt=setInterval(function(){animatearrow();},500);
		animateArrowATPosition(560,320,360);
		document.getElementById("can7-2").onclick=function()
		{
			...
			setTimeout(function()
			{
				...
				myInt=setInterval(function(){animatearrow();},500);
				animateArrowATPosition(595,430,360);
	...
	else if(simsubscreennum==11)
	{
		...
		myInt=setInterval(function(){animatearrow();},500);
		animateArrowATPosition(665,250,360);
		document.getElementById("can11-3r").onclick=function()
		{
			...
			myInt=setInterval(function(){animatearrow();},500);
			animateArrowATPosition(500,246,180);
			document.getElementById("can11-3l").onclick=function()
			{
				...
				myInt=setInterval(function(){animatearrow();},500);
				animateArrowATPosition(593,235,270);
				document.getElementById("can11-3").onclick=function()
				{
					...
					document.getElementById("can11-2").onclick=function()
					{
						...
						setTimeout(function()
						{
							...
							myInt=setInterval(function(){animatearrow();},500);
							animateArrowATPosition(200,280,270);
							document.getElementById("can11-7").onclick=function()
							{
								...
								document.getElementById("can11-6").style.visibility="visible";
								myInt=setInterval(function(){animatearrow();},500);
								animateArrowATPosition(320,360,360);
								document.getElementById("can11-5").onclick=function()
								{
									...
									setTimeout(function()
									{
										...
										myInt = setInterval(function(){ animatearrow(); }, 500);
										animateArrowATPosition(485,500,90);
										document.getElementById("can11-9a").onclick=function()
										{
											...
											{
												myInt = setInterval(function(){ animatearrow(); }, 500);
												animateArrowATPosition(590,500,90);
												document.getElementById("can11-9b").onclick=function(){
													...
													{
														myInt=setInterval(function(){animatearrow();},500);
														animateArrowATPosition(230,320,270);
...
function fillCylinder()
{
	...
	myInt=setInterval(function(){animatearrow();},500);
	animateArrowATPosition(300,225,360);
...
function tamp()
{
	...
	myInt=setInterval(function(){animatearrow();},500);
	animateArrowATPosition(570,180,360);
...
function levelCa()
{
	...
	myInt=setInterval(function(){animatearrow();},500);
	animateArrowATPosition(530,170,270);
...
function removePlunger()
{
	...
	myInt=setInterval(function(){animatearrow();},500);
	animateArrowATPosition(400,200,360);
	document.getElementById("can10-3").onclick=function()
	{
		...
		setTimeout(function()
		{
			...
			setTimeout(function()
			{
				...
				myInt=setInterval(function(){animatearrow();},500);
				animateArrowATPosition(380,450,270);
				document.getElementById("can10-6").onclick=function()
				{
					...
					setTimeout(function()
					{
						...
						myInt=setInterval(function(){animatearrow();},500);
						animateArrowATPosition(440,300,360);
						document.getElementById("can10-2").onclick=function()
						{
							...
							setTimeout(function()
							{
								...
								setTimeout(function()
								{
									...
									myInt=setInterval(function(){animatearrow();},500);
									animateArrowATPosition(340,240,-90);
									document.getElementById("can10-9").onclick=function()
									{
										...
										setTimeout(function()
										{
											...
											myInt=setInterval(function(){animatearrow();},500);
											animateArrowATPosition(255,390,360);
											document.getElementById("can10-10").onclick=function()
											{
												...
												setTimeout(function()
												{
													...
													myInt=setInterval(function(){animatearrow();},500);
													animateArrowATPosition(400,200,-90);
													document.getElementById("can10-12").onclick=function()
													{
														...
														myInt=setInterval(function(){animatearrow();},500);
														animateArrowATPosition(500,225,180);
														document.getElementById("can10-11l").onclick=function()
														{
															...
															setTimeout(function()
															{
																...
																myInt=setInterval(function(){animatearrow();},500);
																animateArrowATPosition(665,215,360);
																document.getElementById("can10-11r").onclick=function()
																{
																	...
																	{
																		myInt=setInterval(function(){animatearrow();},500);
																		animateArrowATPosition(520,468,90);
